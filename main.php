    ...
    <section class="ftco-section">
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                ...
                <li class="nav-item dropdown profile__btn">
                    <a class="nav-link" href="personal.php" id="dropdown05" data-toggle="dropdown" aria-haspopup="true"
        ...
        <div class="grid_afisha">
            ...
            <?php
			 ...
			 // ToDo: придумать способ соеденить эти параметры в одно целое, конечно же разделяя словами 'and' (Прим. param1 and param2 and param3 and ... paramN)
