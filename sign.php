...
<div class="body-background">
   ...
   <form action="auth.php" class="container-fluid d-flex justify-content-center align-items-center h-100" method="post">
      
      <div class="card text-center">
          <h4>Войдите в профиль</h4>
          <div>
              <span>Нет профиля?</span>
              <a href="registr.php" class="text-decoration-none">Зарегистрироваться</a>
          </div>
