...
<html lang="en">
  <head>
	...
	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="ftco-nav">
					<ul class="navbar-nav m-auto">
						...
						<li class="nav-item active"><a href="./exposition.php" class="nav-link">Выставки</a></li>
	  ...
	  <p class="main__header" style='color:#250000;'>Выставки</p>
	<div class="grid_exposition">
		<?php 
			...
			if(isset($_POST['search'])){
				...
				FROM Afisha left join Comments on Comments.num_afish = Afisha.num_afish where type_event = 'выставка' and name_afish like '%".$_POST['search']."%'";
			}
			else{
				...
				where type_event = 'выставка' group by num_afish";
			}
